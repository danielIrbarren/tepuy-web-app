    ...
    for (const req of failedRequests) {
      ...
      try {
        ...
        if (taskUrl !== null) {
          ...
          // triggerMakeWebhook retornó null = Make.com respondió con error o sin task_url
          throw new Error("triggerMakeWebhook retornó null — Make.com no confirmó recepción");
        }
      } catch (webhookErr) {
